...
namespace Luny.Unity.Tests
{
	public sealed class EngineLifecycleTests
	{
		...
		public IEnumerator EngineLifecycleExpectedEventOrder()
		{
			...
			// get observer and test its fields
			var mockObserver = LunyEngine.Instance.GetObserver<EngineLifecycleExpectedEventOrderMock>();
			mockObserver.PostShutdownVerification();
		}*/
	}
}
